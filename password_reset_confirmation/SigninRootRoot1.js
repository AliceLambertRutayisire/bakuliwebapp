    ...
    <SignInRootRootRoot>
            ...
            <FlexColumn3>
              <FlexColumn4>
                ...
                <PasswordField>
                  ...
                  <Vuesaxlineareye
                    src={`https://file.rendit.io/n/uyd6wJyTk799yLlcSBqb.svg`}
                  />
                </PasswordField>
              </FlexColumn4>
      ...
      <BlackFlexColumn>
        <DialogBox>
          <FlexColumn5>
            <FlexRow1>
              <Text6>Password Reset Link</Text6>
              <Vuesaxlineareye
                src={`https://file.rendit.io/n/kpBTJaIq9LDUIS4ynMWU.svg`}
              />
            </FlexRow1>
            <Paragraph>
              We have emailed you a password reset link, check your email.
            </Paragraph>
          </FlexColumn5>
          <FlexColumn6>
            <FlexRow2>
